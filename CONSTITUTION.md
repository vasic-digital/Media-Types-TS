# CONSTITUTION — Media-Types-TS

Project-specific governance for the **Media-Types-TS** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
